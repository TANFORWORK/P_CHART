...
const SPC_AVI_P_CHART = React.lazy(
  () => import("@/pages/SPC_AVI_P_CHART/main/SPC_AVI_P_CHART")
);
const MASTER_UCL_LCL = React.lazy(
  () => import("@/pages/MASTER_UCL_LCL/main/page")
);
const OutOfRuleAction = React.lazy(
  () => import("@/pages/Out_of_Rule_Action/main/page")
);
      ...
      <ThemeProvider>
        <BrowserRouter>
          <Suspense fallback={<Loading />}>
            <Routes>
              <Route path="/smart-pchart-spc-avi" element={<Layout />}>
                {/* Public Routes */}
                <Route
                  index
                  element={
                    <Navigate
                      to="/smart-pchart-spc-avi/spc_avi_chart"
                      replace
                    />
                  }
                />
                ...
                <Route
                  path="/smart-pchart-spc-avi/spc_avi_chart"
                  element={<SPC_AVI_P_CHART />}
                />
                <Route
                  path="/smart-pchart-spc-avi/master_ucl_lcl"
                  element={<MASTER_UCL_LCL />}
                />
                <Route
                  path="/smart-pchart-spc-avi/out_of_rule_action"
                  element={<OutOfRuleAction />}
                />
              </Route>
            </Routes>
          </Suspense>
