...
const Get_main_data = async (start_date: string, end_date: string) => {
  try {
    // Swal loading
    Swal.fire({
      title: "Loading...",
    ...
    const response = await axios.get(
      `${import.meta.env.VITE_API_IP}/smart-spc-avi/spc-avi/filter-record`,
      { params }
    );
